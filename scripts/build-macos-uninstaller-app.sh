...
BUILD_DIR="$DIST_DIR/build/macos-uninstaller"
APP_NAME="Uninstall Sanka Plugin.app"
...
cp "$ROOT_DIR/scripts/uninstall-codex-plugin.sh" "$APP_DIR/Contents/Resources/uninstall-codex-plugin.sh"
cp "$ROOT_DIR/macos/uninstaller-app/launcher.sh" "$APP_DIR/Contents/MacOS/Uninstall Sanka Plugin"
chmod +x "$APP_DIR/Contents/MacOS/Uninstall Sanka Plugin" "$APP_DIR/Contents/Resources/uninstall-codex-plugin.sh"

sed "s/__VERSION__/$VERSION/g" "$ROOT_DIR/macos/uninstaller-app/Info.plist" > "$APP_DIR/Contents/Info.plist"
