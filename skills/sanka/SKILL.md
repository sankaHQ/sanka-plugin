...
5. For deal-to-invoice, do not attempt freee sync. Multiple invoices for one HubSpot deal require an explicit user request or `allow_multiple_invoices` in options.
