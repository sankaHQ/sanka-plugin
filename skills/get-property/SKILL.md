---
description: Load one property from live Sanka. Use when the user explicitly invokes /sakura:get-property.
...
4. Summarize the returned property clearly.
...
- Do not call `search_docs` or `execute` when `get_property` covers the request.
