...
3. Call `list_inventory_transactions` directly.
4. If the client surfaces an authentication prompt or challenge, tell the user to complete Sanka sign-in and then retry.
5. Summarize the returned inventory transactions clearly and do not mix in any local repo or database information.
