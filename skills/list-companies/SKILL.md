---
description: List or search companies in live Sanka with the installed plugin. Use when the user explicitly invokes /sanka:list-companies.
...
- If empty, list the most recent 10 companies.
...
4. Summarize the returned companies clearly and do not mix in any local repo or database information.
