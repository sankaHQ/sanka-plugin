---
description: Create or preview a Sanka invoice draft workflow from a Sanka deal or HubSpot deal URL. Use when the user explicitly invokes /sanka:deal-to-invoice or asks Sanka to create an invoice from a HubSpot deal.
