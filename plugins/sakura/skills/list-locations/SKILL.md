---
description: List or search locations in live Sanka. Use when the user explicitly invokes /sakura:list-locations.
...
2. Call `list_locations` directly.
...
4. Summarize the returned locations clearly and do not mix in any local repo or database information.
