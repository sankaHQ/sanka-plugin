---
description: Load one item from live Sanka. Use when the user explicitly invokes /sakura:get-item.
...
4. Summarize the returned item clearly.
...
- Do not call `search_docs` or `execute` when `get_item` covers the request.
