---
description: Delete inventory from live Sanka. Use when the user explicitly invokes /sakura:delete-inventory.
...
2. Call `delete_inventory` directly.
...
- Do not call `search_docs` or `execute` when `delete_inventory` covers the request.
