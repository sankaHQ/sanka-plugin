---
description: Delete contact from live Sanka. Use when the user explicitly invokes /sakura:delete-contact.
...
2. Call `delete_contact` directly.
...
- Do not call `search_docs` or `execute` when `delete_contact` covers the request.
