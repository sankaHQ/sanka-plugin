---
description: Load one ticket from live Sanka. Use when the user explicitly invokes /sakura:get-ticket.
...
4. Summarize the returned ticket clearly.
...
- Do not call `search_docs` or `execute` when `get_ticket` covers the request.
