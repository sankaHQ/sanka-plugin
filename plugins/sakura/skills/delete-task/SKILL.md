---
description: Delete task from live Sanka. Use when the user explicitly invokes /sakura:delete-task.
...
- Do not call `search_docs` or `execute` when `delete_task` covers the request.
