---
description: Cancel calendar attendance in live Sanka. Use when the user explicitly invokes /sakura:cancel-calendar-attendance.
...
2. Call `cancel_calendar_attendance` directly.
