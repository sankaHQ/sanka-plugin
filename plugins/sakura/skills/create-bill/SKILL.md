---
description: Create bill in live Sanka. Use when the user explicitly invokes /sakura:create-bill.
...
4. Summarize the created bill and surface any returned ids or important fields.
...
- Do not call `search_docs` or `execute` when `create_bill` covers the request.
