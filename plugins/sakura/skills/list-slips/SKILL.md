---
description: List or search slips in live Sanka. Use when the user explicitly invokes /sakura:list-slips.
...
4. Summarize the returned slips clearly and do not mix in any local repo or database information.
...
- Do not call `search_docs` or `execute` when `list_slips` covers the request.
