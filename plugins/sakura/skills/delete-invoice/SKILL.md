---
description: Delete invoice from live Sanka. Use when the user explicitly invokes /sakura:delete-invoice.
...
2. Call `delete_invoice` directly.
...
- Do not call `search_docs` or `execute` when `delete_invoice` covers the request.
