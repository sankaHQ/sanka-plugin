---
description: Delete disbursement from live Sanka. Use when the user explicitly invokes /sakura:delete-disbursement.
...
2. Call `delete_disbursement` directly.
...
- Do not call `search_docs` or `execute` when `delete_disbursement` covers the request.
