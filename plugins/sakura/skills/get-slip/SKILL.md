---
description: Load one slip from live Sanka. Use when the user explicitly invokes /sakura:get-slip.
...
4. Summarize the returned slip clearly.
...
- Do not call `search_docs` or `execute` when `get_slip` covers the request.
