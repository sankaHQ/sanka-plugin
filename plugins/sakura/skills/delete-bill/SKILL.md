---
description: Delete bill from live Sanka. Use when the user explicitly invokes /sakura:delete-bill.
...
- Do not call `search_docs` or `execute` when `delete_bill` covers the request.
