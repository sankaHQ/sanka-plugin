---
description: Update deal in live Sanka. Use when the user explicitly invokes /sakura:update-deal.
...
4. Summarize the updated deal and the changed fields clearly.
