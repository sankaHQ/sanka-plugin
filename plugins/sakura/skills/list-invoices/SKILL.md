---
description: List or search invoices in live Sanka. Use when the user explicitly invokes /sakura:list-invoices.
...
4. Summarize the returned invoices clearly and do not mix in any local repo or database information.
...
- Do not call `search_docs` or `execute` when `list_invoices` covers the request.
