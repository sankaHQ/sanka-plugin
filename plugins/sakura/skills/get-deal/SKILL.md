---
description: Load one deal from live Sanka. Use when the user explicitly invokes /sakura:get-deal.
...
4. Summarize the returned deal clearly.
...
- Do not call `search_docs` or `execute` when `get_deal` covers the request.
