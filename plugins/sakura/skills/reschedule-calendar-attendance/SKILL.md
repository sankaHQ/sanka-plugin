---
description: Reschedule calendar attendance in live Sanka. Use when the user explicitly invokes /sakura:reschedule-calendar-attendance.
...
1. Require the target identifier and the new schedule details. If either is missing, ask a concise follow-up.
2. Call `reschedule_calendar_attendance` directly.
...
4. Summarize the reschedule result clearly.
