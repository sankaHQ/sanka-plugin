---
description: Delete location from live Sanka. Use when the user explicitly invokes /sakura:delete-location.
...
2. Call `delete_location` directly.
...
- Do not call `search_docs` or `execute` when `delete_location` covers the request.
