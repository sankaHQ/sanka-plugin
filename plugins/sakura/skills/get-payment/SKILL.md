---
description: Load one payment from live Sanka. Use when the user explicitly invokes /sakura:get-payment.
...
4. Summarize the returned payment clearly.
