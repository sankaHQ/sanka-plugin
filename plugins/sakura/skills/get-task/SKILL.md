---
description: Load one task from live Sanka. Use when the user explicitly invokes /sakura:get-task.
...
4. Summarize the returned task clearly.
...
- Do not call `search_docs` or `execute` when `get_task` covers the request.
