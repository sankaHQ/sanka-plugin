---
description: Reply to a private inbox thread in live Sanka. Use when the user explicitly invokes /sakura:reply-private-message-thread.
...
2. Call `reply_private_message_thread` directly.
...
4. Confirm the sent reply only after the tool succeeds.
