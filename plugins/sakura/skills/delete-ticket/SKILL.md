---
description: Delete ticket from live Sanka. Use when the user explicitly invokes /sakura:delete-ticket.
...
- Do not call `search_docs` or `execute` when `delete_ticket` covers the request.
