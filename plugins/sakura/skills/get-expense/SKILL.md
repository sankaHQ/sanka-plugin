---
description: Load one expense from live Sanka. Use when the user explicitly invokes /sakura:get-expense.
...
4. Summarize the returned expense clearly.
...
- Do not call `search_docs` or `execute` when `get_expense` covers the request.
