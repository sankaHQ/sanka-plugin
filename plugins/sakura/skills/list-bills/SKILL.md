---
description: List or search bills in live Sanka. Use when the user explicitly invokes /sakura:list-bills.
...
4. Summarize the returned bills clearly and do not mix in any local repo or database information.
