---
description: Update company-wide price table settings in live Sanka. Use when the user explicitly invokes /sakura:update-company-price-table-company.
...
1. Require `company_id` and the pricing change the user wants. If either is missing, ask a concise follow-up.
2. Call `update_company_price_table_company` directly.
...
4. Summarize the resulting company-wide pricing mode or percentage.
