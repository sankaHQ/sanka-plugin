---
description: Create calendar attendance in live Sanka. Use when the user explicitly invokes /sakura:create-calendar-attendance.
disable-model-invocation: true
argument-hint: "[details to create the record]"
---
# Create Calendar Attendance
...
2. Call `create_calendar_attendance` directly.
...
4. Summarize the created calendar attendance and surface any returned ids or important fields.
...
- Do not call `search_docs` or `execute` when `create_calendar_attendance` covers the request.
