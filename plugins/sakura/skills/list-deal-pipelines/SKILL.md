---
description: List or search deal pipelines in live Sanka. Use when the user explicitly invokes /sakura:list-deal-pipelines.
...
2. Call `list_deal_pipelines` directly.
...
4. Summarize the returned deal pipelines clearly and do not mix in any local repo or database information.
