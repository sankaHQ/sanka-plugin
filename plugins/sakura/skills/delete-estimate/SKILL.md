---
description: Delete estimate from live Sanka. Use when the user explicitly invokes /sakura:delete-estimate.
...
2. Call `delete_estimate` directly.
...
- Do not call `search_docs` or `execute` when `delete_estimate` covers the request.
