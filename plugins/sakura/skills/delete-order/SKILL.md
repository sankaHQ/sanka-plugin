---
description: Delete order from live Sanka. Use when the user explicitly invokes /sakura:delete-order.
...
- Do not call `search_docs` or `execute` when `delete_order` covers the request.
