---
description: Load one company from live Sanka. Use when the user explicitly invokes /sakura:get-company.
...
4. Summarize the returned company clearly.
