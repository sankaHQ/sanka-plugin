---
description: List or search disbursements in live Sanka. Use when the user explicitly invokes /sakura:list-disbursements.
...
2. Call `list_disbursements` directly.
...
4. Summarize the returned disbursements clearly and do not mix in any local repo or database information.
