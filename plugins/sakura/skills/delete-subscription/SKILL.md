---
description: Delete subscription from live Sanka. Use when the user explicitly invokes /sakura:delete-subscription.
...
2. Call `delete_subscription` directly.
...
- Do not call `search_docs` or `execute` when `delete_subscription` covers the request.
