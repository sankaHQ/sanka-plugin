---
description: Load one private message thread from live Sanka. Use when the user explicitly invokes /sakura:get-private-message-thread.
disable-model-invocation: true
argument-hint: "<id or lookup details>"
---
# Get Private Message Thread
...
2. Call `get_private_message_thread` directly.
...
4. Summarize the returned private message thread clearly.
...
- Do not call `search_docs` or `execute` when `get_private_message_thread` covers the request.
