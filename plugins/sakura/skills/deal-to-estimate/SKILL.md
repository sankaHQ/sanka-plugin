---
description: Create or preview a Sanka estimate workflow from a Sanka deal or HubSpot deal URL. Use when the user explicitly invokes /sakura:deal-to-estimate or asks Sanka to make an estimate from a HubSpot deal.
