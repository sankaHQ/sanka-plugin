---
description: Load one invoice from live Sanka. Use when the user explicitly invokes /sakura:get-invoice.
...
4. Summarize the returned invoice clearly.
...
- Do not call `search_docs` or `execute` when `get_invoice` covers the request.
