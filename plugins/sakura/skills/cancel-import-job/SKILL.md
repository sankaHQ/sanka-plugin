---
description: Cancel import job in live Sanka. Use when the user explicitly invokes /sakura:cancel-import-job.
...
2. Call `cancel_import_job` directly.
...
- Do not call `search_docs` or `execute` when `cancel_import_job` covers the request.
