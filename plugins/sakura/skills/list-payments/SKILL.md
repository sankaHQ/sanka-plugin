---
description: List or search payments in live Sanka. Use when the user explicitly invokes /sakura:list-payments.
...
4. Summarize the returned payments clearly and do not mix in any local repo or database information.
...
- Do not call `search_docs` or `execute` when `list_payments` covers the request.
