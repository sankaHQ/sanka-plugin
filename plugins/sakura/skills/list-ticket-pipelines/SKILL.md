---
description: List or search ticket pipelines in live Sanka. Use when the user explicitly invokes /sakura:list-ticket-pipelines.
...
2. Call `list_ticket_pipelines` directly.
...
4. Summarize the returned ticket pipelines clearly and do not mix in any local repo or database information.
