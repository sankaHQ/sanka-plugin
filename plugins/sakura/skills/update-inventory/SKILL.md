---
description: Update inventory in live Sanka. Use when the user explicitly invokes /sakura:update-inventory.
...
2. Call `update_inventory` directly.
...
4. Summarize the updated inventory and the changed fields clearly.
