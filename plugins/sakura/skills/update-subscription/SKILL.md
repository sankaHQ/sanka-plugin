---
description: Update subscription in live Sanka. Use when the user explicitly invokes /sakura:update-subscription.
...
2. Call `update_subscription` directly.
...
4. Summarize the updated subscription and the changed fields clearly.
...
- Do not call `search_docs` or `execute` when `update_subscription` covers the request.
