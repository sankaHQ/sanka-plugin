---
description: Update ticket in live Sanka. Use when the user explicitly invokes /sakura:update-ticket.
...
4. Summarize the updated ticket and the changed fields clearly.
...
- Do not call `search_docs` or `execute` when `update_ticket` covers the request.
