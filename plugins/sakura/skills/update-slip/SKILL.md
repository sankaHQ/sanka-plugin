---
description: Update slip in live Sanka. Use when the user explicitly invokes /sakura:update-slip.
...
4. Summarize the updated slip and the changed fields clearly.
