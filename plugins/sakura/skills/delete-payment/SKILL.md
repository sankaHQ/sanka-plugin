---
description: Delete payment from live Sanka. Use when the user explicitly invokes /sakura:delete-payment.
...
2. Call `delete_payment` directly.
...
- Do not call `search_docs` or `execute` when `delete_payment` covers the request.
