---
description: Delete slip from live Sanka. Use when the user explicitly invokes /sakura:delete-slip.
...
- Do not call `search_docs` or `execute` when `delete_slip` covers the request.
